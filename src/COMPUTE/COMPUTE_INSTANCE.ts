...
interface COMPUTE_INSTANCE_TREEOP {
  device: GPUDevice;
...
export class COMPUTE_INSTANCE_TREE {
    device: GPUDevice;
    ...
    constructor({device, POINT_BUFFER,CONFIG_POINT_UBO, SIM_UBO_PARAMS, infoTexVATDetail}:COMPUTE_INSTANCE_TREEOP) {
        this.device = device;
